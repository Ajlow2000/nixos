return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>f", ":lua require('harpoon.ui').nav_file(1)<cr>", { desc = "Navigate to file 1" } )
        vim.keymap.set("n", "<leader>d", ":lua require('harpoon.ui').nav_file(2)<cr>", { desc = "Navigate to file 2" } )
        vim.keymap.set("n", "<leader>s", ":lua require('harpoon.ui').nav_file(3)<cr>", { desc = "Navigate to file 3" } )
        vim.keymap.set("n", "<leader>a", ":lua require('harpoon.ui').nav_file(4)<cr>", { desc = "Navigate to file 4" } )
