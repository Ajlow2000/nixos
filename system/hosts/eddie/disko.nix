/*
  ...
  Reinstall workflow: identical to marvin — see system/hosts/marvin/disko.nix
  for the step-by-step. Substitute `eddie` for `marvin` in commands and
  &host_eddie for &host_marvin in .sops.yaml.
*/
{
  disko.devices = {
    disk = {
